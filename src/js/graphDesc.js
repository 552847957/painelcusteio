export var descs = {
        ...
        p1_5: { // esse grafico no manual é o grafico 1.3, porém na implementação ele eh o grafico p1_5 por causa do numero do objeto dele no html PRESTAR ATENÇÃO AO ALTERAR O CONTEUDO
            ...
            text: 'Esse gráfico exibe o percentual de gasto por área de atuação dos órgãos superiores. Por exemplo os órgãos da área social são os ministérios da Saúde, Educação, Trabalho, Esporte, Cultura, entre outros.'
        },
        ...
        p3_1: {
            title: 'Gráfico de comparativo da proporção dos gastos de cada unidade orçamentária',
            text: 'O gráfico exibe um comparativo da proporção dos gastos de cada unidade orçamentária com determinado item ou conjunto de itens de despesas.  Essa proporção é calculada em relação ao total da despesa administrativa de cada unidade orçamentária. Ou seja, essa proporção representa quando o gasto desses itens consome do total de gastos administrativos de cada unidade orçamentária.  <br/><br/> Em tese, unidade orçamentária que exercem atividades de natureza similares, devem apresentar proporções semelhantes para um mesmo item ou conjunto de despesas administrativas. <br/><br/> O gráfico também exibe uma linha de referência indicando a média de gasto das unidades orçamentárias apresentadas, permitindo comparar a proporção dos gastos de determinado órgão entre si e em relação à média geral de gastos.'
        },
        p3_2: {
            title: 'Gráfico de comparativo do volume dos gastos de cada unidade orçamentária',
            text: 'O gráfico exibe um comparativo do volume dos gastos de cada unidade orçamentária com determinado item ou conjunto de itens de despesa, como também uma linha de referência indicando a média de gasto das unidades orçamentárias apresentados, permitindo comparar o volume dos gastos de determinado unidade entre si e em relação à média geral de gastos. <br/><br/>  Este gráfico possibilita duas formas de ordenação das unidades orçamentárias: pelo total ou pela proporção do gasto no item ou conjunto de itens.'
        },
        ...
        p4_1: { 
            ...
            text: 'O gráfico exibe um comportamento mensal do volume dos gastos para o item ou conjunto de itens de despesas pré-selecionados.'
        },
        p4_2: {
