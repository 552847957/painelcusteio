...
var prefix = '/';
var config = {
    host: "qliksense-qap-cginf.brazilsouth.cloudapp.azure.com",
    prefix: prefix,
    port: 80,
    isSecure: false
};
...
require(["js/qlik"], function(qlik) {
    ...
    $(document).ready(function() {
        ...
        function getTable(vis) {
            var table = vis.table;
            var model = vis.model;
            var htmlTable = '<html xmlns:o=\"urn:schemas-microsoft-com:office:office\" xmlns:x=\"urn:schemas-microsoft-com:office:excel\" xmlns=\"http://www.w3.org/TR/REC-html40\"><head><!--[if gte mso 9]><xml><x:ExcelWorkbook><x:ExcelWorksheets></head><body><table><thead><tr>';
